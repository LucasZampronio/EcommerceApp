    ...
    <section className="w-full">
      ...
      <div className="flex mt-5 mb-5 justify-between">
        ...
        <div className="flex items-center mr-40 gap-6">
          <div onClick={goToCart} className='p-3 hover:bg-neutral-100 hover:border-1 border-1 border-white hover:rounded-xl cursor-pointer'>
            <img className='w-6 h-6' src={cart} alt="" />
          </div>
          <div onClick={goToLogin} className='p-3 hover:bg-neutral-100 hover:border-1 border-1 border-white hover:rounded-xl cursor-pointer'>
